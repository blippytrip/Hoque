...
// Read transactions
router.get("/", auth, roleCheck("receptionist", "doctor"), transactionController.getTransactions);
router.get("/:id", auth, roleCheck("receptionist", "doctor"), transactionController.getTransactionById);
